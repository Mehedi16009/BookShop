<?php 
  ...
  {
    echo "<script>window.lobrandion='user_categories.php'</script>";
  }
  else
  {
    $id=$_GET['id'];
 ...
 if($_SERVER['REQUEST_METHOD']== 'POST' && isset($_POST['update']))
  {
    ...
    $editusercat=$cat->edit_user_cat($cat_title,$id);
  }
...
<?php 
$getusercatbyid=$cat->get_user_cat_by_id($id);
if ($getusercatbyid) {
while ($value=$getusercatbyid->fetch_assoc()) {
?> 
